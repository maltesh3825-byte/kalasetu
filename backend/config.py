...
# Gemini Model endpoint: use gemini-flash-lite-latest (fast and active quota available)
DEFAULT_GEMINI_MODEL = "gemini-flash-lite-latest"
GEMINI_MODEL = (os.getenv("GEMINI_MODEL", DEFAULT_GEMINI_MODEL) or DEFAULT_GEMINI_MODEL).strip()
if GEMINI_MODEL in ("gemini-1.5-flash", "gemini-3.6-flash", "gemini-2.5-flash"):
